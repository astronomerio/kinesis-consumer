...
import logger from '@astronomerio/astronomer-logger';
...
class RecordProcessor {
  ...
  processRecords({ checkpointer, records }, cb) {
    ...
    this.doProcessRecords(records).then(() => {
      this.logger.debug('finished doProcess, trying to checkpoint');
  ...
  async doProcessRecords(records) {
